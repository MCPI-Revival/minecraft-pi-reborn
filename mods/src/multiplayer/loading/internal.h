...
// Init
#define init(name) void _init_multiplayer_loading_##name()
init(packets);
init(thread);
init(misc);
init(terrain);
...
extern bool _server_using_improved_loading;
// Request Full Chunk Data
extern bool _request_full_chunk;
// Disable Terrain Generation
extern bool _inhibit_terrain_generation;
