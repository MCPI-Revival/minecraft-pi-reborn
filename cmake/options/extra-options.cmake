...
# Updater
mcpi_option(UPDATER_JSON_URL "Update Checker URL" STRING "${MCPI_REPO_HOST}/api/v1/repos/${MCPI_REPO_PATH}/releases/latest")
mcpi_option(UPDATER_VERSION_PLACEHOLDER "Version Placeholder In Updater URLs" STRING "%VERSION%")
if(MCPI_IS_APPIMAGE_BUILD)
    ...
    get_package_file_name(appimage_package_file_name "${MCPI_UPDATER_VERSION_PLACEHOLDER}")
    string(APPEND appimage_package_file_name "${MCPI_APPIMAGE_EXT}")
    mcpi_option(APPIMAGE_DOWNLOAD_URL "AppImage Download URL" STRING "${MCPI_REPO}/releases/download/${MCPI_UPDATER_VERSION_PLACEHOLDER}/${appimage_package_file_name}")
else()
    mcpi_option(UPDATER_WEB_URL "Update URL For Web Browsers" STRING "${MCPI_REPO}/releases/tag/${MCPI_UPDATER_VERSION_PLACEHOLDER}")
endif()